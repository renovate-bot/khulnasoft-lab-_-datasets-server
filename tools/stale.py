...
# Copyright 2022 The khulnasoft-lab Authors, the AllenNLP library authors.
# All rights reserved.

"""
Script to close stale issue. Taken in part from the AllenNLP repository.
https://github.com/allenai/allennlp.
Copied from https://github.com/khulnasoft-lab/transformers
"""
...
def main():
    ...
    repo = g.get_repo("khulnasoft-lab/datasets-server")
    ...
    for issue in open_issues:
        ...
        if (
            ...
            issue.create_comment(
                ...
                "[contributing guidelines](https://github.com/khulnasoft-lab/datasets-server/blob/main/CONTRIBUTING.md) "
